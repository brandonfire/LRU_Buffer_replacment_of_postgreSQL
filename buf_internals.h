...
typedef struct sbufdesc
{
	...
	//Chengbin: change the bufferdesc to double linked list
	int			freePrev;       
	//END
 ...
 */
 //chengbin: add the END define for double linked list
#define FREE_END_OF_LIST (-1) 
#define FREENEXT_NOT_IN_LIST	(-2)
#define FREEP_NOT_IN_LIST	(-3)
//END
/*
